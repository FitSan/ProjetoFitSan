...
<table class="table" cellpadding="5">
    ...
    ?>
        <tr style="margin-bottom: 20px">
            <td style="width: 150px"><img class="profile-user-img img-responsive img-circle" src="<?= htmlspecialchars(!empty($linha['foto']) ? $linha['foto'] : 'img/user-avatar-placeholder.png') ?>" alt="User profile picture"></td>
            ...
            <td style="width: 300px"><?= date('d/m/Y H:i:s', dataParse($linha['datanasc'])) ?></td>
