...
$query_mensal = "select dados_meta.data_add, dados_meta.peso_add, meta.peso_final from dados_meta join meta on dados_meta.meta_id=meta.id where MONTH(data_add) = $mes_dado and meta_id=".$linha_meta['id'];
