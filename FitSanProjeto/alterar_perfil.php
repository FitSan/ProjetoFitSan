...
if (!empty($fotosel)){
    ...
    if (!@is_readable($temp)) die('Upload não encontrado'); // Para se não foi encontrado o arquivo temporário
    copy($temp, $caminho) or die('Upload não copiado'); // Move o arquivo enviado para a pasta de uploads
